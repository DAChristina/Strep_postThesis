...
gamma_7F_adults <- user(0, min = 0, max = 1)
gamma_12F_kids <- user(0, min = 0, max = 1)
gamma_12F_adults <- user(0, min = 0, max = 1)

gamma_1[1] <- gamma_1_kids
gamma_1[2] <- gamma_1_adults
gamma_1[3] <- gamma_1_adults
gamma_7F[1] <- gamma_7F_kids
gamma_7F[2] <- gamma_7F_adults
gamma_7F[3] <- gamma_7F_adults
gamma_12F[1] <- gamma_12F_kids
gamma_12F[2] <- gamma_12F_adults
gamma_12F[3] <- gamma_12F_adults
...
dim(n_cases_1) <- N_age
dim(n_cases_7F) <- N_age
dim(n_cases_12F) <- N_age
...
n_cases_1[] <- rbinom(D[i], 1 - exp(-gamma_1[i] * dt))
n_cases_7F[] <- rbinom(D[i], 1 - exp(-gamma_7F[i] * dt))
n_cases_12F[] <- rbinom(D[i], 1 - exp(-gamma_12F[i] * dt))
...
update(cases_12F[]) <- n_AD[i] + n_cases_12F[i]
